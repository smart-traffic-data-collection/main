...
# --- Configuration ---
CALIB_FILE = '/media/pink-rabbit/Data/SmartTrafficMonitoring/experiment_v2x/data/UrbanIng-V2X/dataset/20241126_0004_crossing2_00/calibration.json'
TRACKS_FILE = '/media/pink-rabbit/Data/SmartTrafficMonitoring/experiment_v2x/data/UrbanIng-V2X/labels/20241126_0004_crossing2_00.json'
TARGET_CAMERA_PATH = '/media/pink-rabbit/Data/SmartTrafficMonitoring/experiment_v2x/data/UrbanIng-V2X/dataset/20241126_0004_crossing2_00/crossing2_34_thermal_camera'

CAMERA_NAME = os.path.basename(TARGET_CAMERA_PATH.rstrip('/'))
OUTPUT_DIR = f'/media/pink-rabbit/Data/SmartTrafficMonitoring/experiment_v2x/data/UrbanIng-V2X/yolo_labels/labels_0004/yolo_{CAMERA_NAME}/'
...
if __name__ == "__main__":
    ...
    for track in tracks_data["tracks"]:
        ...
        for i, ts in enumerate(track["timestamps"]):
            ...
            corners_2d, _ = cv2.projectPoints(corners_3d, rvec, , K, D)
